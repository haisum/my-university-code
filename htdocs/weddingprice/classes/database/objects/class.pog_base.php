<?php
require_once(ABSOLUTE_PATH . "/classes/database/configuration.php");
class POG_Base
{
	/**
	 * Overloading
	...
	{
		include_once(ABSOLUTE_PATH . "/classes/database/plugins/IPlugin.php");
		include_once(ABSOLUTE_PATH . "/classes/database/plugin.".strtolower($method).".php");
