...
class upload
{
	...
	var $user_full_name;
	var $thumb_name;
	var $validImageType = array('image/gif','image/jpeg','image/png','image/bmp','image/pjpeg');
	...
	function validateImage(){
		//print_r($this->user_file_type);
		//echo '<br>';
		//print_r($this->validImageType);die();
		if(in_array($this->user_file_type,$this->validImageType)){
			return true;
		}
		else return false;
	}
