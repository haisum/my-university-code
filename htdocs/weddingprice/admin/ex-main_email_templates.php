...
$limit = 20; 								//how many items to show per page
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name order by id asc";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "main_email_templates.php"; 	//your file name  (the name of this file)
	$page = $_GET['page'];
	if($page) 
...
<script>
function update(status,industry_id) 
{
	var divname = "#div"+industry_id;
  $(divname).html('<p><img src="images/loader1.gif"/><br><font size=1><b>Please wait!</font></b></p>');
  $(divname).load("update_status.php?status="+status+"&industry_id="+industry_id);

}

function delete_industry(industry_id)
{
	var confirm_value = confirm('Are you sure you want to delete this industry? Doing so will delete the classes & schedules associated with this industry. This action is IR-REVERSIBLE.');
	
	if(confirm_value == true)
	{
		window.location ="delete_industry.php?industry_id="+industry_id;
	}
}
</script>
<?
...
<table class="global" width="100%" cellpadding="0" cellspacing="0">
						<thead>
						    <tr>
						    	<th width="58"><span style="width:30%">ID</span></th>
					    	  <th width="132">Email</th>
					    	  <th width="814">Email Body</th>
...
?>
						    <tr>
						    	...
						    	<td><?=$row['emailbody'];?></td>
						    	<td>
						    		<a href="edit_email_templates.php?id=<?=$row['id'];?>"><img src="images/icon_edit.png" alt="edit" class="help" title="Edit"/></a>
