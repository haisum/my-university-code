    ...
    $.extend(Wysiwyg, {
        insertImage : function( szURL, attributes )
        {
            ...
            if ( self.constructor == Wysiwyg && szURL && szURL.length > 0 )
            {
                ...
                if ( attributes )
                {
                    self.editorDoc.execCommand('insertImage', true, '#jwysiwyg#');
                ...
                {
                    self.editorDoc.execCommand('insertImage', true, szURL);
                }
            }
        },
        ...
        createLink : function( szURL )
        {
            ...
            if ( self.constructor == Wysiwyg && szURL && szURL.length > 0 )
            {
                ...
                {
                    if ($.browser.msie) self.focus();
                    self.editorDoc.execCommand('unlink', true, []);
                    self.editorDoc.execCommand('createLink', true, szURL);
                }
        ...
        insertHtml : function( szHTML )
        {
            ...
            if ( self.constructor == Wysiwyg && szHTML && szHTML.length > 0 )
            {
                ...
                {
                    self.editorDoc.execCommand('insertHTML', true, szHTML);
                }
            }
        },
