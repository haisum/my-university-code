...
$isEdit = false;
$row = array();
if(isset($_REQUEST['specialofferid'])){
	$query = mysql_query('SELECT * from specialoffer where specialofferid=' . intval($_REQUEST['specialofferid']) . ' LIMIT 1');
...
<!-- End 2nd level tab -->All fields marked with (<strong>*</strong>) are compulsory</div>
				...
				<div class="content nomargin">
					...
					?>
                    	...
                    	<input type="hidden" name="id" value="<?=$row['specialofferid'];?>" />
					...
					?>
					  ...
					  <?php if(!$isEdit){ ?>
					    ...
					    *<br/>
					    <?=select(getSuppliers(),'', 'supplierid', 'supplierid')?>
					  ...
					  <?php } ?>
					    <label>Title:</label>
					    *<br/>
					    <input type='text' class="text" id="title"  name="title" value='<? if($isEdit) echo $row['title']; ?>'/>
                        <span id="name-error"></span>
					  <br/>	
					  <br/> 
					  ...
					  <label>Link:</label>
					    *<br/>
					    <input type='text' class="text" id="link"  name="link" value='<? if($isEdit) echo $row['link']; ?>'/>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>
					    ...
					    <label>Content:</label>
					    *<br/>
					    <textarea class="text" id="content"  name="content"><? if($isEdit) echo $row['content']; ?></textarea>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>	
					   ...
					   <label>Days:</label>
					    *<br/>
					    <input type="text" class="text numberOnly" id="days"  name="days" value="<? if($isEdit) echo $row['days']; ?>" />
                        <span id="name-error"></span>
					  <br/>	
					  <br/>						  
					   ...
					   <label>Status:</label>
					    *<br/>
					    <?=select(array( 'ACTIVE'=>'Active', 'INACTIVE'=>'Inactive'), $row['status'], 'status', 'status')?>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>	
					  ...
					  <label>Date Starts:</label>
					    *dd-mm-yyyy<br/>
					    <input type='text' class="text" id="date"  name="date" value='<? if($isEdit) echo normalDate($row['date']); ?>'/>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>
					  ...
					  <label>Date Ends:</label>
					    *dd-mm-yyyy<br/>
					    <input type='text' class="text" id="dateend"  name="dateend" value='<? if($isEdit) echo normalDate($row['dateend']); ?>'/>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>
					  
					  <input type="submit" id="edit_email_template" class="button_dark" value="<? if($isEdit) echo "Edit Offer"; else echo "Add Offer"; ?>"/>
