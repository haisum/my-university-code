...
$limit = 20; 								//how many items to show per page
	...
	*/
	...
	$targetpage = "main-faqcategory-listing.php"; 	//your file name  (the name of this file)
	$page = $_GET['page'];
	if($page) 
...
<script>
function delete_(faqcategoryid)
{
	var confirm_value = confirm('Are you sure you want to delete this FAQ Category, this will also delete all questions associated with this category? This action is IR-REVERSIBLE.');
	
	if(confirm_value == true)
	{
		window.location.href ="delete.php?faqcategoryid="+faqcategoryid;
	}
}
          ...
          <div class="onecolumn">
		    ...
		    <div class="header">
                  ...
                  <ul class="second_level_tab">
						<li>
							<a href="add-edit-faqcategory.php">
								Add New
							</a>
						</li>
					</ul>  
...
?>
						    <tr>
							  ...
							  <td width="40">
									<a href="add-edit-faqcategory.php?faqcategoryid=<?=$row['faqcategoryid']?>"><img src="images/icon_edit.png" alt="edit" class="help" title="Edit"/></a>
									&nbsp;&nbsp;
									<a href="javascript:void(0);"><img src="images/icon_delete.png" alt="Delete" class="help" title="Delete Row" onclick="delete_('<?=$row['faqcategoryid']?>'); return false;" /></a>   									
							  </td>
						    </tr>
                <?
              }
