...
if(isset($_REQUEST['reviewid'])){
	...
	$query = mysql_query("SELECT review.* from review where reviewid=$reviewid");
...
<!-- End 2nd level tab -->All fields marked with (<strong>*</strong>) are compulsory</div>
				...
				<div class="content nomargin">
					...
					?>                    
					  ...
					  <label>Rating:</label>
					    *<br/>
					    <?=select(getRatings(), $row['rating'], 'rating', 'rating' )?>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>	
					  ...
					  <input type="submit" id="edit_email_template" class="button_dark" value="<? if($isEdit) echo "Edit Review"; else echo "Add Review"; ?>"/>
