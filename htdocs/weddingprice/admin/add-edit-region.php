...
if(isset($_REQUEST['regionid'])){
	$query = mysql_query('SELECT * from region where regionid=' . intval($_REQUEST['regionid']) . ' LIMIT 1');
...
<!-- End 2nd level tab -->All fields marked with (<strong>*</strong>) are compulsory</div>
				...
				<div class="content nomargin">
					...
					?>
                    	...
                    	<input type="hidden" name="id" value="<?=$row['regionid'];?>" />
					...
					?>
					  ...
					  <!-- Begin form elements -->
					    ...
					    *<br/>
					    <input type="text" class="text" size="60" id="name"  name="name" value="<? if($isEdit) echo $row['name']; ?>" />
                        <span id="name-error"></span>
					  <br/>	
					  <br/>	
					  	
					  <input type="submit" id="edit_email_template" class="button_dark" value="<? if($isEdit) echo "Edit Region"; else echo "Add Region"; ?>"/>
