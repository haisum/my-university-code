...
function delete_(regionid)
{
	var confirm_value = confirm('Are you sure you want to delete this region? This will also delete all requests for this region. This action is IR-REVERSIBLE.');
	
	if(confirm_value == true)
	{
		window.location.href ="delete.php?regionid="+regionid;
	}
}
...
?>
						    <tr>
							  ...
							  <th><a href='main-weddingcategory-listing.php?regionid=<?=$row['regionid']?>'>View</a></th>
							  <th><a href='main-supplier-listing.php?regionid=<?=$row['regionid']?>'>View</a></th>
							  <th><a href='main-buyer-listing.php?regionid=<?=$row['regionid']?>'>View</a></th>
							  <td width="40">
									<a href="add-edit-region.php?regionid=<?=$row['regionid']?>"><img src="images/icon_edit.png" alt="edit" class="help" title="Edit"/></a>
									&nbsp;&nbsp;
									<a href="javascript:void(0);"><img src="images/icon_delete.png" alt="Delete" class="help" title="Delete Row" onclick="delete_('<?=$row['regionid']?>'); return false;" /></a>   									
							  </td>
						    </tr>
                <?
              }
