...
function delete_(categoryid)
{
	var confirm_value = confirm('Are you sure you want to delete this category? This will also delete all requests for this category. This action is IR-REVERSIBLE.');
	
	if(confirm_value == true)
	{
		window.location.href ="delete.php?categoryid="+categoryid;
	}
}
...
?>
						    <tr>
							  ...
							  <th><a href='main-weddingcategory-listing.php?categoryid=<?=$row['categoryid']?>'>View</a></th>
							  <th><a href='main-supplier-listing.php?categoryid=<?=$row['categoryid']?>'>View</a></th>
							  <td width="40">
									<a href="add-edit-category.php?categoryid=<?=$row['categoryid']?>"><img src="images/icon_edit.png" alt="edit" class="help" title="Edit"/></a>
									&nbsp;&nbsp;
									<a href="javascript:void(0);"><img src="images/icon_delete.png" alt="Delete" class="help" title="Delete Row" onclick="delete_('<?=$row['categoryid']?>'); return false;" /></a>   									
							  </td>
						    </tr>
                <?
              }
