...
$limit = 20; 								//how many items to show per page
	...
	*/
	...
	$targetpage = "main-goldpayment-listing.php"; 	//your file name  (the name of this file)
	$page = $_GET['page'];
	if($page) 
	...
	/* Get data. */
	$sql = "SELECT goldpayment.* , supplier.name FROM goldpayment, supplier WHERE supplier.supplierid = goldpayment.supplierid ORDER BY goldpayment.date DESC LIMIT 0, 20";
    ...
    <?
		...
		<div id="content_wrapper">
			...
			<!-- Begin one column box --><ul class="first_level_tab">
				<li>
<a href="" class="active">
						Read Only List of Gold Account Payments</a>
				</li>
				<li></li>
				<li></li>
			</ul>
...
<table class="global" width="100%" cellpadding="0" cellspacing="0">
						<thead>
						    <tr>
							  ...
							  <th width="40">Date Payed</th>
							  <th width="40">Date Expires</th>
						    </tr>
						</thead>
						<tbody>
<?
...
?>
						    <tr>
							  ...
							  <th width="40"><?=$row['package'] . ' Months.'?></th>							  
							  <th width="40"><?=$row['amount']?></th>							  
							  <th width="40"><?=$row['status']?></th>							  
							  <th width="40"><?=date('d-m-Y ', strtotime($row['date']))?></th>							  
							  <th width="40"><?=date('d-m-Y ', strtotime($row['expiredate']))?></th>	
						    </tr>
                <?
              }
                ?>
