				...
				<div class="content nomargin">
                    ...
                    <form action="<?=$filename2;?>.pro.php" method="post" onsubmit="validate(this);">
					  ...
					  <!-- Begin form elements -->
					    ...
					    *<br/>
					    <input type="text" class="text" size="60" id="category"  name="category" value="" />
					...
					<textarea id="details" name="desc" rows="10" cols="5" class="wysiwyg" style="width:100%"></textarea>
                    ...
                    <br /><br />
					  <input type="submit" id="edit_email_template" class="button_dark" value="Add Job Type"/>
					<br/>	
                      <br/>
