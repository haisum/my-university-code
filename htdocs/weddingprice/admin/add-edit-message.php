...
if(isset($_REQUEST['messageid'])){
	...
	$query = mysql_query("SELECT message.* from message where messageid=$messageid");
...
<!-- End 2nd level tab -->All fields marked with (<strong>*</strong>) are compulsory</div>
				...
				<div class="content nomargin">
					...
					?>
                    	...
                    	<input type="hidden" name="messageid" value="<?=$_GET['messageid'];?>" />
					...
					?>                    
					  ...
					  <label>Unread:</label>
					    *<br/>
					    <?=select(array('YES' => 'No', 'NO' => 'Yes'), $row['isread'], 'isread', 'isread' )?>
                        <span id="name-error"></span>
					  <br/>	
					  <br/>	
