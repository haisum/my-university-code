...
$limit = 20; 								//how many items to show per page
	...
	*/
	...
	$targetpage = "main-configuration-listing.php"; 	//your file name  (the name of this file)
	$page = $_GET['page'];
	if($page) 
	...
	/* Get data. */
	$sql = "SELECT configuration.* FROM configuration order by configurationid desc LIMIT $start, $limit";
...
?>
						    <tr>
							  <th width="40"><?=getConfigName($row['name'])?></th>
							  <th width="40"><?=$row['value']?></th>	
							  
							  <td width="40">
									<a href="add-edit-configuration.php?configurationid=<?=$row['configurationid']?>"><img src="images/icon_edit.png" alt="edit" class="help" title="Edit"/></a>   									
							  </td>
						    </tr>
                <?
              }
