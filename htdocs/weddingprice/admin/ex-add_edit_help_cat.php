...
if(isset($_REQUEST['id'])){
	$id = $_REQUEST['id'];
	$query = mysql_query("select * from help_category where help_cat_id = '$id'");
				...
				<div class="content nomargin">
					...
					?>
					  ...
					  <!-- Begin form elements -->
					    ...
					    *<br/>
					    <input type="text" class="text" size="60" id="category"  name="category" value="<? if($isEdit) echo $category; ?>" />
