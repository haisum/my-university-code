...
$query = mysql_query("select * from emailtemplate where id = '$id'");
...
<!-- End 2nd level tab -->All fields marked with (<strong>*</strong>) are compulsory</div>
				...
				<div class="content nomargin">
					...
					<div class="content">
                    <form action="<?=$filename2;?>.pro.php" method="post">
					...
					<textarea id="details" name="emailbody" rows="10" cols="5" class="wysiwyg" style="width:100%"><?=$emailbody;?></textarea>
					  ...
					  <input type="submit" id="edit_email_template" class="button_dark" value="Edit Industry"/>
