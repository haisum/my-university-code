...
<html>
    ...
    <head>
        ...
        <title>Wedding Price | Gold membership Payment Confirmation</title>
    ...
    <body>
        ...
        <div id="background">
            <div class="wrapper">
                ...
                <div id="rightCol">
					<h1 class="myTitle">Payment Confirmation for Gold Account</h1>
					<div class='success'>
						Thankyou for your payment. You will be updated to Gold member as soon as we recieve confirmation from Paypal. Please logout and re-login after your payment has been done so that you can enjoy benefits of Gold memebrsip.
